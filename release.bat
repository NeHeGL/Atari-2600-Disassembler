@echo off
:: ============================================================
::  NeHe Atari 2600 Smart Disassembler — Release Helper
::  Usage:  release.bat
::
::  What it does:
...
::         - Builds NeHe-Atari2600-Disassembler.exe via PyInstaller
...
echo.
echo  NeHe Atari 2600 Smart Disassembler - Release Helper
echo  =====================================================
echo.
...
echo    https://github.com/NeHeGL/Atari-2600-Disassembler/actions
echo.
echo  The finished release will appear at:
echo    https://github.com/NeHeGL/Atari-2600-Disassembler/releases/tag/%VERSION%
echo.
goto :eof
